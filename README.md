...
- :office: Senior Engineer at **Broadcom** (VMware Cloud Foundation) — scaling private cloud infrastructure across 2,000+ hosts
...
| **JitAPI** | MCP server that lets LLMs discover and call any API dynamically via semantic search + dependency graphs. Published on PyPI. | [:link: GitHub](https://github.com/nk3750/jitapi) &#183; [:package: PyPI](https://pypi.org/project/jitapi/) |
